...
w.loading()
info_data = readfile.lookfile(gamename+'_pyphi')
# --------------------------------------------
...
f3 = pygame.freetype.Font(r"src/Saira-Medium.ttf", 6)
...
while 1:
    ...
    # 更新屏幕内容
    screen.blit(tap, ccap(data['LineList'][0]['pos'],))
