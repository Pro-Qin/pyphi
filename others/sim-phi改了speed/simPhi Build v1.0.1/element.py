...
class Note:
    ...
    def upgrade(self, surface: pygame.surface.Surface, beat: float):
        ...
        if beat > self.at:
            beat = self.at
        _y = (alterobj.b2s(self.at)-(judge_line.floor_position))* core.DEBUG_N*self.speed*800
        # _y = 0
    ...
    def blit(self, surface):
        ...
        if not (x < 0 or x > core.WIDTH or y < 0 or y > core.HEIGHT):
...
class Hold(Note):
    ...
    def upgrade(self, surface: pygame.surface.Surface, beat: float):
        ...
        _y = _y * core.DEBUG_N*judge_line.speed/6
