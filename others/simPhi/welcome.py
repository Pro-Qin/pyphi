...
def choose():
    ...
    font_EN=pygame.freetype.Font(r"others/sim-phi_pyphi/simPhi/resources/Saira-Medium.ttf",18*1.3)#设置字体
    #背景图片
    image_surface = pygame.image.load('others/sim-phi_pyphi/simPhi/resources/texture/background.png').convert()      #加载背景
    ...
    #加载歌曲背景
    songpic = pygame.image.load('others/sim-phi_pyphi/simPhi/resources/texture/song.png').convert_alpha()
    songpic = pygame.transform.scale(songpic,(854/4*1.5,183/4*1.5))          #调整大小 

    songstart = pygame.image.load('others/sim-phi_pyphi/simPhi/resources/texture/start.png').convert_alpha()
    songstart = pygame.transform.scale(songstart,(71/4*1.5,80/4*1.5))          #调整大小
    pygame.mixer.music.load('others/sim-phi_pyphi/simPhi/resources/audio/music.mp3')#背景音乐
